...
type PrescriptionsAPI interface {
	...
	/*
	PrescriptionsPost Upload prescription image

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiPrescriptionsPostRequest
	*/
	PrescriptionsPost(ctx context.Context) ApiPrescriptionsPostRequest

	// PrescriptionsPostExecute executes the request
	PrescriptionsPostExecute(r ApiPrescriptionsPostRequest) (*http.Response, error)
}

// PrescriptionsAPIService PrescriptionsAPI service
type PrescriptionsAPIService service

type ApiPrescriptionsPostRequest struct {
	ctx context.Context
	ApiService PrescriptionsAPI
	image *os.File
	userId *int32
}

func (r ApiPrescriptionsPostRequest) Image(image *os.File) ApiPrescriptionsPostRequest {
	r.image = image
	return r
}

func (r ApiPrescriptionsPostRequest) UserId(userId int32) ApiPrescriptionsPostRequest {
	r.userId = &userId
	return r
}

func (r ApiPrescriptionsPostRequest) Execute() (*http.Response, error) {
	return r.ApiService.PrescriptionsPostExecute(r)
}
...
PrescriptionsPost Upload prescription image
 ...
 @return ApiPrescriptionsPostRequest
*/
func (a *PrescriptionsAPIService) PrescriptionsPost(ctx context.Context) ApiPrescriptionsPostRequest {
	return ApiPrescriptionsPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *PrescriptionsAPIService) PrescriptionsPostExecute(r ApiPrescriptionsPostRequest) (*http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PrescriptionsAPIService.PrescriptionsPost")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/prescriptions"
	...
	parameterAddToHeaderOrQuery(localVarFormParams, "userId", r.userId, "", "")
