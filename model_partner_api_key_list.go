...
// checks if the PartnerApiKeyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerApiKeyList{}

// PartnerApiKeyList struct for PartnerApiKeyList
type PartnerApiKeyList struct {
	Data []PartnerApiKey `json:"data,omitempty"`
	Meta *PartnerApiKeyListMeta `json:"meta,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PartnerApiKeyList PartnerApiKeyList

// NewPartnerApiKeyList instantiates a new PartnerApiKeyList object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartnerApiKeyList() *PartnerApiKeyList {
	this := PartnerApiKeyList{}
	return &this
}

// NewPartnerApiKeyListWithDefaults instantiates a new PartnerApiKeyList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPartnerApiKeyListWithDefaults() *PartnerApiKeyList {
	this := PartnerApiKeyList{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PartnerApiKeyList) GetData() []PartnerApiKey {
	if o == nil || IsNil(o.Data) {
		var ret []PartnerApiKey
		return ret
	}
	return o.Data
}
...
func (o *PartnerApiKeyList) GetDataOk() ([]PartnerApiKey, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *PartnerApiKeyList) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []PartnerApiKey and assigns it to the Data field.
func (o *PartnerApiKeyList) SetData(v []PartnerApiKey) {
	o.Data = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *PartnerApiKeyList) GetMeta() PartnerApiKeyListMeta {
	if o == nil || IsNil(o.Meta) {
		var ret PartnerApiKeyListMeta
		return ret
	}
	return *o.Meta
}
...
// and a boolean to check if the value has been set.
func (o *PartnerApiKeyList) GetMetaOk() (*PartnerApiKeyListMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *PartnerApiKeyList) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given PartnerApiKeyListMeta and assigns it to the Meta field.
func (o *PartnerApiKeyList) SetMeta(v PartnerApiKeyListMeta) {
	o.Meta = &v
}

func (o PartnerApiKeyList) MarshalJSON() ([]byte, error) {
...
func (o PartnerApiKeyList) ToMap() (map[string]interface{}, error) {
...
func (o *PartnerApiKeyList) UnmarshalJSON(data []byte) (err error) {
	varPartnerApiKeyList := _PartnerApiKeyList{}

	err = json.Unmarshal(data, &varPartnerApiKeyList)

	if err != nil {
		return err
	}

	*o = PartnerApiKeyList(varPartnerApiKeyList)
...
type NullablePartnerApiKeyList struct {
	value *PartnerApiKeyList
	isSet bool
}

func (v NullablePartnerApiKeyList) Get() *PartnerApiKeyList {
	return v.value
}

func (v *NullablePartnerApiKeyList) Set(val *PartnerApiKeyList) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerApiKeyList) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerApiKeyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerApiKeyList(val *PartnerApiKeyList) *NullablePartnerApiKeyList {
	return &NullablePartnerApiKeyList{value: val, isSet: true}
}

func (v NullablePartnerApiKeyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerApiKeyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
