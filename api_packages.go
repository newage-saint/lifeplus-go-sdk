...
type PackagesAPI interface {
	...
	Book a wellness or homecare package

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiBookPackageRequest
	*/
	BookPackage(ctx context.Context) ApiBookPackageRequest

	// BookPackageExecute executes the request
	//  @return SuccessResponse
	BookPackageExecute(r ApiBookPackageRequest) (*SuccessResponse, *http.Response, error)

	/*
	ListPackages List packages

	List available packages (wellness, homecare)

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListPackagesRequest
	*/
	ListPackages(ctx context.Context) ApiListPackagesRequest

	// ListPackagesExecute executes the request
	//  @return []Package
	ListPackagesExecute(r ApiListPackagesRequest) ([]Package, *http.Response, error)
}

// PackagesAPIService PackagesAPI service
type PackagesAPIService service

type ApiBookPackageRequest struct {
	ctx context.Context
	ApiService PackagesAPI
	packageBooking *PackageBooking
}

func (r ApiBookPackageRequest) PackageBooking(packageBooking PackageBooking) ApiBookPackageRequest {
	r.packageBooking = &packageBooking
	return r
}

func (r ApiBookPackageRequest) Execute() (*SuccessResponse, *http.Response, error) {
	return r.ApiService.BookPackageExecute(r)
}
...
Book a wellness or homecare package
 ...
 @return ApiBookPackageRequest
*/
func (a *PackagesAPIService) BookPackage(ctx context.Context) ApiBookPackageRequest {
	return ApiBookPackageRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SuccessResponse
func (a *PackagesAPIService) BookPackageExecute(r ApiBookPackageRequest) (*SuccessResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "PackagesAPIService.BookPackage")
	if err != nil {
	...
	if r.packageBooking == nil {
		return localVarReturnValue, nil, reportError("packageBooking is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.packageBooking
...
func (r ApiListPackagesRequest) Type_(type_ int32) ApiListPackagesRequest {
	r.type_ = &type_
	return r
}
...
func (r ApiListPackagesRequest) PerPage(perPage int32) ApiListPackagesRequest {
	r.perPage = &perPage
	return r
}
...
List available packages (wellness, homecare)
 ...
 @return ApiListPackagesRequest
*/
func (a *PackagesAPIService) ListPackages(ctx context.Context) ApiListPackagesRequest {
	return ApiListPackagesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []Package
func (a *PackagesAPIService) ListPackagesExecute(r ApiListPackagesRequest) ([]Package, *http.Response, error) {
	var (
