...
// checks if the PartnerAnalyticsPeriod type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerAnalyticsPeriod{}

// PartnerAnalyticsPeriod struct for PartnerAnalyticsPeriod
...
type _PartnerAnalyticsPeriod PartnerAnalyticsPeriod

// NewPartnerAnalyticsPeriod instantiates a new PartnerAnalyticsPeriod object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartnerAnalyticsPeriod() *PartnerAnalyticsPeriod {
	this := PartnerAnalyticsPeriod{}
	return &this
}

// NewPartnerAnalyticsPeriodWithDefaults instantiates a new PartnerAnalyticsPeriod object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPartnerAnalyticsPeriodWithDefaults() *PartnerAnalyticsPeriod {
	this := PartnerAnalyticsPeriod{}
	return &this
}

// GetStart returns the Start field value if set, zero value otherwise.
func (o *PartnerAnalyticsPeriod) GetStart() string {
...
func (o *PartnerAnalyticsPeriod) GetStartOk() (*string, bool) {
	if o == nil || IsNil(o.Start) {
		return nil, false
	}
	return o.Start, true
...
func (o *PartnerAnalyticsPeriod) HasStart() bool {
	if o != nil && !IsNil(o.Start) {
		return true
	}
...
func (o *PartnerAnalyticsPeriod) SetStart(v string) {
	o.Start = &v
}

// GetEnd returns the End field value if set, zero value otherwise.
func (o *PartnerAnalyticsPeriod) GetEnd() string {
...
// and a boolean to check if the value has been set.
func (o *PartnerAnalyticsPeriod) GetEndOk() (*string, bool) {
	if o == nil || IsNil(o.End) {
		return nil, false
	}
	return o.End, true
...
func (o *PartnerAnalyticsPeriod) HasEnd() bool {
	if o != nil && !IsNil(o.End) {
		return true
	}
...
func (o *PartnerAnalyticsPeriod) SetEnd(v string) {
	o.End = &v
}

func (o PartnerAnalyticsPeriod) MarshalJSON() ([]byte, error) {
...
func (o PartnerAnalyticsPeriod) ToMap() (map[string]interface{}, error) {
...
func (o *PartnerAnalyticsPeriod) UnmarshalJSON(data []byte) (err error) {
	varPartnerAnalyticsPeriod := _PartnerAnalyticsPeriod{}

	err = json.Unmarshal(data, &varPartnerAnalyticsPeriod)

	if err != nil {
		return err
	}

	*o = PartnerAnalyticsPeriod(varPartnerAnalyticsPeriod)
...
type NullablePartnerAnalyticsPeriod struct {
	value *PartnerAnalyticsPeriod
	isSet bool
}

func (v NullablePartnerAnalyticsPeriod) Get() *PartnerAnalyticsPeriod {
	return v.value
}

func (v *NullablePartnerAnalyticsPeriod) Set(val *PartnerAnalyticsPeriod) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerAnalyticsPeriod) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerAnalyticsPeriod) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerAnalyticsPeriod(val *PartnerAnalyticsPeriod) *NullablePartnerAnalyticsPeriod {
	return &NullablePartnerAnalyticsPeriod{value: val, isSet: true}
}

func (v NullablePartnerAnalyticsPeriod) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerAnalyticsPeriod) UnmarshalJSON(src []byte) error {
	v.isSet = true
