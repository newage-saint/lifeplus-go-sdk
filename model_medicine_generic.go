...
// checks if the MedicineGeneric type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MedicineGeneric{}

// MedicineGeneric struct for MedicineGeneric
type MedicineGeneric struct {
	Id *int32 `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _MedicineGeneric MedicineGeneric

// NewMedicineGeneric instantiates a new MedicineGeneric object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMedicineGeneric() *MedicineGeneric {
	this := MedicineGeneric{}
	return &this
}

// NewMedicineGenericWithDefaults instantiates a new MedicineGeneric object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewMedicineGenericWithDefaults() *MedicineGeneric {
	this := MedicineGeneric{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *MedicineGeneric) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *MedicineGeneric) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *MedicineGeneric) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *MedicineGeneric) SetId(v int32) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *MedicineGeneric) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *MedicineGeneric) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *MedicineGeneric) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *MedicineGeneric) SetName(v string) {
	o.Name = &v
}

func (o MedicineGeneric) MarshalJSON() ([]byte, error) {
...
func (o MedicineGeneric) ToMap() (map[string]interface{}, error) {
...
func (o *MedicineGeneric) UnmarshalJSON(data []byte) (err error) {
	varMedicineGeneric := _MedicineGeneric{}

	err = json.Unmarshal(data, &varMedicineGeneric)

	if err != nil {
		return err
	}

	*o = MedicineGeneric(varMedicineGeneric)
...
type NullableMedicineGeneric struct {
	value *MedicineGeneric
	isSet bool
}

func (v NullableMedicineGeneric) Get() *MedicineGeneric {
	return v.value
}

func (v *NullableMedicineGeneric) Set(val *MedicineGeneric) {
	v.value = val
	v.isSet = true
}

func (v NullableMedicineGeneric) IsSet() bool {
	return v.isSet
}

func (v *NullableMedicineGeneric) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMedicineGeneric(val *MedicineGeneric) *NullableMedicineGeneric {
	return &NullableMedicineGeneric{value: val, isSet: true}
}

func (v NullableMedicineGeneric) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMedicineGeneric) UnmarshalJSON(src []byte) error {
	v.isSet = true
