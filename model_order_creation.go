...
// checks if the OrderCreation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderCreation{}

// OrderCreation struct for OrderCreation
type OrderCreation struct {
	...
	DeliveryAddressId *int32 `json:"delivery_address_id,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _OrderCreation OrderCreation

// NewOrderCreation instantiates a new OrderCreation object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOrderCreation(orderType string, cartId int32, paymentMethod string) *OrderCreation {
	this := OrderCreation{}
...
// NewOrderCreationWithDefaults instantiates a new OrderCreation object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOrderCreationWithDefaults() *OrderCreation {
	this := OrderCreation{}
	return &this
}

// GetOrderType returns the OrderType field value
func (o *OrderCreation) GetOrderType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OrderCreation) GetOrderTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrderCreation) SetOrderType(v string) {
	o.OrderType = v
}

// GetCartId returns the CartId field value
func (o *OrderCreation) GetCartId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrderCreation) GetCartIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrderCreation) SetCartId(v int32) {
	o.CartId = v
}

// GetPaymentMethod returns the PaymentMethod field value
func (o *OrderCreation) GetPaymentMethod() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *OrderCreation) GetPaymentMethodOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrderCreation) SetPaymentMethod(v string) {
	o.PaymentMethod = v
}

// GetDeliveryAddressId returns the DeliveryAddressId field value if set, zero value otherwise.
func (o *OrderCreation) GetDeliveryAddressId() int32 {
	if o == nil || IsNil(o.DeliveryAddressId) {
		var ret int32
		return ret
	}
	return *o.DeliveryAddressId
}

// GetDeliveryAddressIdOk returns a tuple with the DeliveryAddressId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *OrderCreation) GetDeliveryAddressIdOk() (*int32, bool) {
	if o == nil || IsNil(o.DeliveryAddressId) {
		return nil, false
	}
	return o.DeliveryAddressId, true
}

// HasDeliveryAddressId returns a boolean if a field has been set.
func (o *OrderCreation) HasDeliveryAddressId() bool {
	if o != nil && !IsNil(o.DeliveryAddressId) {
		return true
	}
...
// SetDeliveryAddressId gets a reference to the given int32 and assigns it to the DeliveryAddressId field.
func (o *OrderCreation) SetDeliveryAddressId(v int32) {
	o.DeliveryAddressId = &v
}

func (o OrderCreation) MarshalJSON() ([]byte, error) {
...
func (o OrderCreation) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	toSerialize["order_type"] = o.OrderType
	toSerialize["cart_id"] = o.CartId
	toSerialize["payment_method"] = o.PaymentMethod
	if !IsNil(o.DeliveryAddressId) {
		toSerialize["delivery_address_id"] = o.DeliveryAddressId
	}
...
func (o *OrderCreation) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderCreation := _OrderCreation{}

	err = json.Unmarshal(data, &varOrderCreation)

	if err != nil {
		return err
	}

	*o = OrderCreation(varOrderCreation)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "delivery_address_id")
...
type NullableOrderCreation struct {
	value *OrderCreation
	isSet bool
}

func (v NullableOrderCreation) Get() *OrderCreation {
	return v.value
}

func (v *NullableOrderCreation) Set(val *OrderCreation) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderCreation) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderCreation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderCreation(val *OrderCreation) *NullableOrderCreation {
	return &NullableOrderCreation{value: val, isSet: true}
}

func (v NullableOrderCreation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderCreation) UnmarshalJSON(src []byte) error {
	v.isSet = true
