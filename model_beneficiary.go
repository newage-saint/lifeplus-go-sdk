...
func (o *Beneficiary) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *Beneficiary) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *Beneficiary) SetId(v int32) {
	o.Id = &v
}
...
func (o *Beneficiary) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *Beneficiary) GetRelationship() string {
...
// and a boolean to check if the value has been set.
func (o *Beneficiary) GetRelationshipOk() (*string, bool) {
	if o == nil || IsNil(o.Relationship) {
		return nil, false
	}
...
func (o *Beneficiary) HasRelationship() bool {
	if o != nil && !IsNil(o.Relationship) {
		return true
	}
...
func (o *Beneficiary) SetRelationship(v string) {
	o.Relationship = &v
}

// GetPhone returns the Phone field value if set, zero value otherwise.
func (o *Beneficiary) GetPhone() string {
...
// and a boolean to check if the value has been set.
func (o *Beneficiary) GetPhoneOk() (*string, bool) {
	if o == nil || IsNil(o.Phone) {
		return nil, false
	}
	return o.Phone, true
...
func (o *Beneficiary) HasPhone() bool {
	if o != nil && !IsNil(o.Phone) {
		return true
	}
...
func (o *Beneficiary) SetPhone(v string) {
	o.Phone = &v
}
