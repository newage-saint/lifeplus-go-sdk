...
// checks if the LifestyleCategory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LifestyleCategory{}

// LifestyleCategory struct for LifestyleCategory
...
type _LifestyleCategory LifestyleCategory

// NewLifestyleCategory instantiates a new LifestyleCategory object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLifestyleCategory() *LifestyleCategory {
	this := LifestyleCategory{}
	return &this
}

// NewLifestyleCategoryWithDefaults instantiates a new LifestyleCategory object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewLifestyleCategoryWithDefaults() *LifestyleCategory {
	this := LifestyleCategory{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *LifestyleCategory) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *LifestyleCategory) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *LifestyleCategory) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *LifestyleCategory) SetId(v int32) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *LifestyleCategory) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *LifestyleCategory) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *LifestyleCategory) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *LifestyleCategory) SetName(v string) {
	o.Name = &v
}

func (o LifestyleCategory) MarshalJSON() ([]byte, error) {
...
func (o LifestyleCategory) ToMap() (map[string]interface{}, error) {
...
func (o *LifestyleCategory) UnmarshalJSON(data []byte) (err error) {
	varLifestyleCategory := _LifestyleCategory{}

	err = json.Unmarshal(data, &varLifestyleCategory)

	if err != nil {
		return err
	}

	*o = LifestyleCategory(varLifestyleCategory)
...
type NullableLifestyleCategory struct {
	value *LifestyleCategory
	isSet bool
}

func (v NullableLifestyleCategory) Get() *LifestyleCategory {
	return v.value
}

func (v *NullableLifestyleCategory) Set(val *LifestyleCategory) {
	v.value = val
	v.isSet = true
}

func (v NullableLifestyleCategory) IsSet() bool {
	return v.isSet
}

func (v *NullableLifestyleCategory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLifestyleCategory(val *LifestyleCategory) *NullableLifestyleCategory {
	return &NullableLifestyleCategory{value: val, isSet: true}
}

func (v NullableLifestyleCategory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLifestyleCategory) UnmarshalJSON(src []byte) error {
	v.isSet = true
