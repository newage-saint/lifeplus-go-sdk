...
// checks if the OrderStatusUpdate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OrderStatusUpdate{}

// OrderStatusUpdate struct for OrderStatusUpdate
...
type _OrderStatusUpdate OrderStatusUpdate

// NewOrderStatusUpdate instantiates a new OrderStatusUpdate object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOrderStatusUpdate(status string) *OrderStatusUpdate {
	this := OrderStatusUpdate{}
	this.Status = status
	return &this
}

// NewOrderStatusUpdateWithDefaults instantiates a new OrderStatusUpdate object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOrderStatusUpdateWithDefaults() *OrderStatusUpdate {
	this := OrderStatusUpdate{}
	return &this
}

// GetStatus returns the Status field value
func (o *OrderStatusUpdate) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *OrderStatusUpdate) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *OrderStatusUpdate) SetStatus(v string) {
	o.Status = v
}

// GetTrackingNumber returns the TrackingNumber field value if set, zero value otherwise.
func (o *OrderStatusUpdate) GetTrackingNumber() string {
...
// and a boolean to check if the value has been set.
func (o *OrderStatusUpdate) GetTrackingNumberOk() (*string, bool) {
	if o == nil || IsNil(o.TrackingNumber) {
		return nil, false
	}
...
func (o *OrderStatusUpdate) HasTrackingNumber() bool {
	if o != nil && !IsNil(o.TrackingNumber) {
		return true
	}
...
func (o *OrderStatusUpdate) SetTrackingNumber(v string) {
	o.TrackingNumber = &v
}

// GetNotes returns the Notes field value if set, zero value otherwise.
func (o *OrderStatusUpdate) GetNotes() string {
...
// and a boolean to check if the value has been set.
func (o *OrderStatusUpdate) GetNotesOk() (*string, bool) {
	if o == nil || IsNil(o.Notes) {
		return nil, false
	}
	return o.Notes, true
...
func (o *OrderStatusUpdate) HasNotes() bool {
	if o != nil && !IsNil(o.Notes) {
		return true
	}
...
func (o *OrderStatusUpdate) SetNotes(v string) {
	o.Notes = &v
}

func (o OrderStatusUpdate) MarshalJSON() ([]byte, error) {
...
func (o OrderStatusUpdate) ToMap() (map[string]interface{}, error) {
...
func (o *OrderStatusUpdate) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderStatusUpdate := _OrderStatusUpdate{}

	err = json.Unmarshal(data, &varOrderStatusUpdate)

	if err != nil {
		return err
	}

	*o = OrderStatusUpdate(varOrderStatusUpdate)
...
type NullableOrderStatusUpdate struct {
	value *OrderStatusUpdate
	isSet bool
}

func (v NullableOrderStatusUpdate) Get() *OrderStatusUpdate {
	return v.value
}

func (v *NullableOrderStatusUpdate) Set(val *OrderStatusUpdate) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderStatusUpdate) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderStatusUpdate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderStatusUpdate(val *OrderStatusUpdate) *NullableOrderStatusUpdate {
	return &NullableOrderStatusUpdate{value: val, isSet: true}
}

func (v NullableOrderStatusUpdate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderStatusUpdate) UnmarshalJSON(src []byte) error {
	v.isSet = true
