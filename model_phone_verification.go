...
// checks if the PhoneVerification type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PhoneVerification{}

// PhoneVerification struct for PhoneVerification
...
type _PhoneVerification PhoneVerification

// NewPhoneVerification instantiates a new PhoneVerification object
...
// NewPhoneVerificationWithDefaults instantiates a new PhoneVerification object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPhoneVerificationWithDefaults() *PhoneVerification {
	this := PhoneVerification{}
	return &this
}

// GetOtp returns the Otp field value if set, zero value otherwise.
func (o *PhoneVerification) GetOtp() string {
...
func (o *PhoneVerification) GetOtpOk() (*string, bool) {
	if o == nil || IsNil(o.Otp) {
		return nil, false
	}
	return o.Otp, true
...
func (o *PhoneVerification) HasOtp() bool {
	if o != nil && !IsNil(o.Otp) {
		return true
	}
...
func (o *PhoneVerification) SetOtp(v string) {
	o.Otp = &v
}

func (o PhoneVerification) MarshalJSON() ([]byte, error) {
...
func (o PhoneVerification) ToMap() (map[string]interface{}, error) {
...
func (o *PhoneVerification) UnmarshalJSON(data []byte) (err error) {
	varPhoneVerification := _PhoneVerification{}

	err = json.Unmarshal(data, &varPhoneVerification)

	if err != nil {
		return err
	}

	*o = PhoneVerification(varPhoneVerification)
...
type NullablePhoneVerification struct {
	value *PhoneVerification
	isSet bool
}

func (v NullablePhoneVerification) Get() *PhoneVerification {
	return v.value
}

func (v *NullablePhoneVerification) Set(val *PhoneVerification) {
	v.value = val
	v.isSet = true
}

func (v NullablePhoneVerification) IsSet() bool {
	return v.isSet
}

func (v *NullablePhoneVerification) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePhoneVerification(val *PhoneVerification) *NullablePhoneVerification {
	return &NullablePhoneVerification{value: val, isSet: true}
}

func (v NullablePhoneVerification) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePhoneVerification) UnmarshalJSON(src []byte) error {
	v.isSet = true
