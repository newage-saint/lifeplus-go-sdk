...
// checks if the PackageBooking type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageBooking{}

// PackageBooking struct for PackageBooking
type PackageBooking struct {
	PackageId int32 `json:"package_id"`
	AdditionalProperties map[string]interface{}
}

type _PackageBooking PackageBooking

// NewPackageBooking instantiates a new PackageBooking object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPackageBooking(packageId int32) *PackageBooking {
	this := PackageBooking{}
	this.PackageId = packageId
	return &this
}

// NewPackageBookingWithDefaults instantiates a new PackageBooking object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPackageBookingWithDefaults() *PackageBooking {
	this := PackageBooking{}
	return &this
}

// GetPackageId returns the PackageId field value
func (o *PackageBooking) GetPackageId() int32 {
	if o == nil {
		var ret int32
		return ret
	}
...
func (o *PackageBooking) GetPackageIdOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PackageBooking) SetPackageId(v int32) {
	o.PackageId = v
}

func (o PackageBooking) MarshalJSON() ([]byte, error) {
...
func (o PackageBooking) ToMap() (map[string]interface{}, error) {
...
func (o *PackageBooking) UnmarshalJSON(data []byte) (err error) {
	...
	varPackageBooking := _PackageBooking{}

	err = json.Unmarshal(data, &varPackageBooking)

	if err != nil {
		return err
	}

	*o = PackageBooking(varPackageBooking)
...
type NullablePackageBooking struct {
	value *PackageBooking
	isSet bool
}

func (v NullablePackageBooking) Get() *PackageBooking {
	return v.value
}

func (v *NullablePackageBooking) Set(val *PackageBooking) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageBooking) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageBooking) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageBooking(val *PackageBooking) *NullablePackageBooking {
	return &NullablePackageBooking{value: val, isSet: true}
}

func (v NullablePackageBooking) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageBooking) UnmarshalJSON(src []byte) error {
	v.isSet = true
