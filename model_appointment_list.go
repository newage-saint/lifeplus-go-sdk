...
// checks if the AppointmentList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppointmentList{}

// AppointmentList Appointment list response with pagination
...
type _AppointmentList AppointmentList

// NewAppointmentList instantiates a new AppointmentList object
...
// NewAppointmentListWithDefaults instantiates a new AppointmentList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAppointmentListWithDefaults() *AppointmentList {
	this := AppointmentList{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *AppointmentList) GetData() []Appointment {
...
func (o *AppointmentList) GetDataOk() ([]Appointment, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *AppointmentList) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
func (o *AppointmentList) SetData(v []Appointment) {
	o.Data = v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *AppointmentList) GetMeta() PaginationMeta {
...
// and a boolean to check if the value has been set.
func (o *AppointmentList) GetMetaOk() (*PaginationMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *AppointmentList) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
func (o *AppointmentList) SetMeta(v PaginationMeta) {
	o.Meta = &v
}

func (o AppointmentList) MarshalJSON() ([]byte, error) {
...
func (o AppointmentList) ToMap() (map[string]interface{}, error) {
...
func (o *AppointmentList) UnmarshalJSON(data []byte) (err error) {
	varAppointmentList := _AppointmentList{}

	err = json.Unmarshal(data, &varAppointmentList)

	if err != nil {
		return err
	}

	*o = AppointmentList(varAppointmentList)
...
type NullableAppointmentList struct {
	value *AppointmentList
	isSet bool
}

func (v NullableAppointmentList) Get() *AppointmentList {
	return v.value
}

func (v *NullableAppointmentList) Set(val *AppointmentList) {
	v.value = val
	v.isSet = true
}

func (v NullableAppointmentList) IsSet() bool {
	return v.isSet
}

func (v *NullableAppointmentList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAppointmentList(val *AppointmentList) *NullableAppointmentList {
	return &NullableAppointmentList{value: val, isSet: true}
}

func (v NullableAppointmentList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAppointmentList) UnmarshalJSON(src []byte) error {
	v.isSet = true
