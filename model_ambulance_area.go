...
// checks if the AmbulanceArea type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AmbulanceArea{}

// AmbulanceArea struct for AmbulanceArea
type AmbulanceArea struct {
	Id *int32 `json:"id,omitempty"`
	Name *string `json:"name,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AmbulanceArea AmbulanceArea

// NewAmbulanceArea instantiates a new AmbulanceArea object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAmbulanceArea() *AmbulanceArea {
	this := AmbulanceArea{}
	return &this
}

// NewAmbulanceAreaWithDefaults instantiates a new AmbulanceArea object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAmbulanceAreaWithDefaults() *AmbulanceArea {
	this := AmbulanceArea{}
	return &this
}

// GetId returns the Id field value if set, zero value otherwise.
func (o *AmbulanceArea) GetId() int32 {
	if o == nil || IsNil(o.Id) {
		var ret int32
		return ret
	}
...
func (o *AmbulanceArea) GetIdOk() (*int32, bool) {
	if o == nil || IsNil(o.Id) {
		return nil, false
	}
	return o.Id, true
...
func (o *AmbulanceArea) HasId() bool {
	if o != nil && !IsNil(o.Id) {
		return true
	}
...
func (o *AmbulanceArea) SetId(v int32) {
	o.Id = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *AmbulanceArea) GetName() string {
...
// and a boolean to check if the value has been set.
func (o *AmbulanceArea) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *AmbulanceArea) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *AmbulanceArea) SetName(v string) {
	o.Name = &v
}

func (o AmbulanceArea) MarshalJSON() ([]byte, error) {
...
func (o AmbulanceArea) ToMap() (map[string]interface{}, error) {
...
func (o *AmbulanceArea) UnmarshalJSON(data []byte) (err error) {
	varAmbulanceArea := _AmbulanceArea{}

	err = json.Unmarshal(data, &varAmbulanceArea)

	if err != nil {
		return err
	}

	*o = AmbulanceArea(varAmbulanceArea)
...
type NullableAmbulanceArea struct {
	value *AmbulanceArea
	isSet bool
}

func (v NullableAmbulanceArea) Get() *AmbulanceArea {
	return v.value
}

func (v *NullableAmbulanceArea) Set(val *AmbulanceArea) {
	v.value = val
	v.isSet = true
}

func (v NullableAmbulanceArea) IsSet() bool {
	return v.isSet
}

func (v *NullableAmbulanceArea) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAmbulanceArea(val *AmbulanceArea) *NullableAmbulanceArea {
	return &NullableAmbulanceArea{value: val, isSet: true}
}

func (v NullableAmbulanceArea) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAmbulanceArea) UnmarshalJSON(src []byte) error {
	v.isSet = true
