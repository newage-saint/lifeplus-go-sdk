...
// checks if the DiagnosticList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DiagnosticList{}

// DiagnosticList List response for /diagnostics
type DiagnosticList struct {
	Data []Diagnostic `json:"data,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DiagnosticList DiagnosticList

// NewDiagnosticList instantiates a new DiagnosticList object
...
// NewDiagnosticListWithDefaults instantiates a new DiagnosticList object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDiagnosticListWithDefaults() *DiagnosticList {
	this := DiagnosticList{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *DiagnosticList) GetData() []Diagnostic {
...
func (o *DiagnosticList) GetDataOk() ([]Diagnostic, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *DiagnosticList) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given []Diagnostic and assigns it to the Data field.
func (o *DiagnosticList) SetData(v []Diagnostic) {
	o.Data = v
}

func (o DiagnosticList) MarshalJSON() ([]byte, error) {
...
func (o DiagnosticList) ToMap() (map[string]interface{}, error) {
...
func (o *DiagnosticList) UnmarshalJSON(data []byte) (err error) {
	varDiagnosticList := _DiagnosticList{}

	err = json.Unmarshal(data, &varDiagnosticList)

	if err != nil {
		return err
	}

	*o = DiagnosticList(varDiagnosticList)
...
type NullableDiagnosticList struct {
	value *DiagnosticList
	isSet bool
}

func (v NullableDiagnosticList) Get() *DiagnosticList {
	return v.value
}

func (v *NullableDiagnosticList) Set(val *DiagnosticList) {
	v.value = val
	v.isSet = true
}

func (v NullableDiagnosticList) IsSet() bool {
	return v.isSet
}

func (v *NullableDiagnosticList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiagnosticList(val *DiagnosticList) *NullableDiagnosticList {
	return &NullableDiagnosticList{value: val, isSet: true}
}

func (v NullableDiagnosticList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiagnosticList) UnmarshalJSON(src []byte) error {
	v.isSet = true
