...
// checks if the PartnerApiKeyCreation type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PartnerApiKeyCreation{}

// PartnerApiKeyCreation struct for PartnerApiKeyCreation
type PartnerApiKeyCreation struct {
	Data *PartnerApiKeyCreateData `json:"data,omitempty"`
	Meta *PartnerApiKeyCreateMeta `json:"meta,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _PartnerApiKeyCreation PartnerApiKeyCreation

// NewPartnerApiKeyCreation instantiates a new PartnerApiKeyCreation object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPartnerApiKeyCreation() *PartnerApiKeyCreation {
	this := PartnerApiKeyCreation{}
	return &this
}

// NewPartnerApiKeyCreationWithDefaults instantiates a new PartnerApiKeyCreation object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPartnerApiKeyCreationWithDefaults() *PartnerApiKeyCreation {
	this := PartnerApiKeyCreation{}
	return &this
}

// GetData returns the Data field value if set, zero value otherwise.
func (o *PartnerApiKeyCreation) GetData() PartnerApiKeyCreateData {
	if o == nil || IsNil(o.Data) {
		var ret PartnerApiKeyCreateData
		return ret
	}
	return *o.Data
}
...
func (o *PartnerApiKeyCreation) GetDataOk() (*PartnerApiKeyCreateData, bool) {
	if o == nil || IsNil(o.Data) {
		return nil, false
	}
	return o.Data, true
...
func (o *PartnerApiKeyCreation) HasData() bool {
	if o != nil && !IsNil(o.Data) {
		return true
	}
...
// SetData gets a reference to the given PartnerApiKeyCreateData and assigns it to the Data field.
func (o *PartnerApiKeyCreation) SetData(v PartnerApiKeyCreateData) {
	o.Data = &v
}

// GetMeta returns the Meta field value if set, zero value otherwise.
func (o *PartnerApiKeyCreation) GetMeta() PartnerApiKeyCreateMeta {
	if o == nil || IsNil(o.Meta) {
		var ret PartnerApiKeyCreateMeta
		return ret
	}
	return *o.Meta
}
...
// and a boolean to check if the value has been set.
func (o *PartnerApiKeyCreation) GetMetaOk() (*PartnerApiKeyCreateMeta, bool) {
	if o == nil || IsNil(o.Meta) {
		return nil, false
	}
	return o.Meta, true
...
func (o *PartnerApiKeyCreation) HasMeta() bool {
	if o != nil && !IsNil(o.Meta) {
		return true
	}
...
// SetMeta gets a reference to the given PartnerApiKeyCreateMeta and assigns it to the Meta field.
func (o *PartnerApiKeyCreation) SetMeta(v PartnerApiKeyCreateMeta) {
	o.Meta = &v
}

func (o PartnerApiKeyCreation) MarshalJSON() ([]byte, error) {
...
func (o PartnerApiKeyCreation) ToMap() (map[string]interface{}, error) {
...
func (o *PartnerApiKeyCreation) UnmarshalJSON(data []byte) (err error) {
	varPartnerApiKeyCreation := _PartnerApiKeyCreation{}

	err = json.Unmarshal(data, &varPartnerApiKeyCreation)

	if err != nil {
		return err
	}

	*o = PartnerApiKeyCreation(varPartnerApiKeyCreation)
...
type NullablePartnerApiKeyCreation struct {
	value *PartnerApiKeyCreation
	isSet bool
}

func (v NullablePartnerApiKeyCreation) Get() *PartnerApiKeyCreation {
	return v.value
}

func (v *NullablePartnerApiKeyCreation) Set(val *PartnerApiKeyCreation) {
	v.value = val
	v.isSet = true
}

func (v NullablePartnerApiKeyCreation) IsSet() bool {
	return v.isSet
}

func (v *NullablePartnerApiKeyCreation) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePartnerApiKeyCreation(val *PartnerApiKeyCreation) *NullablePartnerApiKeyCreation {
	return &NullablePartnerApiKeyCreation{value: val, isSet: true}
}

func (v NullablePartnerApiKeyCreation) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePartnerApiKeyCreation) UnmarshalJSON(src []byte) error {
	v.isSet = true
