...
// checks if the AnalyticsSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnalyticsSummary{}

// AnalyticsSummary struct for AnalyticsSummary
...
type _AnalyticsSummary AnalyticsSummary

// NewAnalyticsSummary instantiates a new AnalyticsSummary object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAnalyticsSummary() *AnalyticsSummary {
	this := AnalyticsSummary{}
	return &this
}

// NewAnalyticsSummaryWithDefaults instantiates a new AnalyticsSummary object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAnalyticsSummaryWithDefaults() *AnalyticsSummary {
	this := AnalyticsSummary{}
	return &this
}

// GetClicks returns the Clicks field value if set, zero value otherwise.
func (o *AnalyticsSummary) GetClicks() int32 {
...
func (o *AnalyticsSummary) GetClicksOk() (*int32, bool) {
	if o == nil || IsNil(o.Clicks) {
		return nil, false
	}
...
func (o *AnalyticsSummary) HasClicks() bool {
	if o != nil && !IsNil(o.Clicks) {
		return true
	}
...
func (o *AnalyticsSummary) SetClicks(v int32) {
	o.Clicks = &v
}

// GetRegistrations returns the Registrations field value if set, zero value otherwise.
func (o *AnalyticsSummary) GetRegistrations() int32 {
...
// and a boolean to check if the value has been set.
func (o *AnalyticsSummary) GetRegistrationsOk() (*int32, bool) {
	if o == nil || IsNil(o.Registrations) {
		return nil, false
	}
...
func (o *AnalyticsSummary) HasRegistrations() bool {
	if o != nil && !IsNil(o.Registrations) {
		return true
	}
...
func (o *AnalyticsSummary) SetRegistrations(v int32) {
	o.Registrations = &v
}

// GetTransactions returns the Transactions field value if set, zero value otherwise.
func (o *AnalyticsSummary) GetTransactions() int32 {
...
// and a boolean to check if the value has been set.
func (o *AnalyticsSummary) GetTransactionsOk() (*int32, bool) {
	if o == nil || IsNil(o.Transactions) {
		return nil, false
	}
...
func (o *AnalyticsSummary) HasTransactions() bool {
	if o != nil && !IsNil(o.Transactions) {
		return true
	}
...
func (o *AnalyticsSummary) SetTransactions(v int32) {
	o.Transactions = &v
}

// GetRevenue returns the Revenue field value if set, zero value otherwise.
func (o *AnalyticsSummary) GetRevenue() float32 {
...
// and a boolean to check if the value has been set.
func (o *AnalyticsSummary) GetRevenueOk() (*float32, bool) {
	if o == nil || IsNil(o.Revenue) {
		return nil, false
	}
...
func (o *AnalyticsSummary) HasRevenue() bool {
	if o != nil && !IsNil(o.Revenue) {
		return true
	}
...
func (o *AnalyticsSummary) SetRevenue(v float32) {
	o.Revenue = &v
}

// GetCommission returns the Commission field value if set, zero value otherwise.
func (o *AnalyticsSummary) GetCommission() float32 {
...
// and a boolean to check if the value has been set.
func (o *AnalyticsSummary) GetCommissionOk() (*float32, bool) {
	if o == nil || IsNil(o.Commission) {
		return nil, false
	}
...
func (o *AnalyticsSummary) HasCommission() bool {
	if o != nil && !IsNil(o.Commission) {
		return true
	}
...
func (o *AnalyticsSummary) SetCommission(v float32) {
	o.Commission = &v
}

func (o AnalyticsSummary) MarshalJSON() ([]byte, error) {
...
func (o AnalyticsSummary) ToMap() (map[string]interface{}, error) {
...
func (o *AnalyticsSummary) UnmarshalJSON(data []byte) (err error) {
	varAnalyticsSummary := _AnalyticsSummary{}

	err = json.Unmarshal(data, &varAnalyticsSummary)

	if err != nil {
		return err
	}

	*o = AnalyticsSummary(varAnalyticsSummary)
...
type NullableAnalyticsSummary struct {
	value *AnalyticsSummary
	isSet bool
}

func (v NullableAnalyticsSummary) Get() *AnalyticsSummary {
	return v.value
}

func (v *NullableAnalyticsSummary) Set(val *AnalyticsSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableAnalyticsSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableAnalyticsSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnalyticsSummary(val *AnalyticsSummary) *NullableAnalyticsSummary {
	return &NullableAnalyticsSummary{value: val, isSet: true}
}

func (v NullableAnalyticsSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnalyticsSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
