...
// checks if the PackageServiceUsage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PackageServiceUsage{}

// PackageServiceUsage Record usage of a package service
type PackageServiceUsage struct {
...
type _PackageServiceUsage PackageServiceUsage

// NewPackageServiceUsage instantiates a new PackageServiceUsage object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPackageServiceUsage(serviceType string, usageDate time.Time) *PackageServiceUsage {
	this := PackageServiceUsage{}
	this.ServiceType = serviceType
	this.UsageDate = usageDate
	return &this
}

// NewPackageServiceUsageWithDefaults instantiates a new PackageServiceUsage object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewPackageServiceUsageWithDefaults() *PackageServiceUsage {
	this := PackageServiceUsage{}
	return &this
}

// GetServiceType returns the ServiceType field value
func (o *PackageServiceUsage) GetServiceType() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *PackageServiceUsage) GetServiceTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PackageServiceUsage) SetServiceType(v string) {
	o.ServiceType = v
}

// GetUsageDate returns the UsageDate field value
func (o *PackageServiceUsage) GetUsageDate() time.Time {
	if o == nil {
		var ret time.Time
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *PackageServiceUsage) GetUsageDateOk() (*time.Time, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *PackageServiceUsage) SetUsageDate(v time.Time) {
	o.UsageDate = v
}

// GetProviderId returns the ProviderId field value if set, zero value otherwise.
func (o *PackageServiceUsage) GetProviderId() int32 {
...
// and a boolean to check if the value has been set.
func (o *PackageServiceUsage) GetProviderIdOk() (*int32, bool) {
	if o == nil || IsNil(o.ProviderId) {
		return nil, false
	}
...
func (o *PackageServiceUsage) HasProviderId() bool {
	if o != nil && !IsNil(o.ProviderId) {
		return true
	}
...
func (o *PackageServiceUsage) SetProviderId(v int32) {
	o.ProviderId = &v
}

// GetNotes returns the Notes field value if set, zero value otherwise.
func (o *PackageServiceUsage) GetNotes() string {
...
// and a boolean to check if the value has been set.
func (o *PackageServiceUsage) GetNotesOk() (*string, bool) {
	if o == nil || IsNil(o.Notes) {
		return nil, false
	}
	return o.Notes, true
...
func (o *PackageServiceUsage) HasNotes() bool {
	if o != nil && !IsNil(o.Notes) {
		return true
	}
...
func (o *PackageServiceUsage) SetNotes(v string) {
	o.Notes = &v
}

// GetCost returns the Cost field value if set, zero value otherwise.
func (o *PackageServiceUsage) GetCost() float32 {
...
// and a boolean to check if the value has been set.
func (o *PackageServiceUsage) GetCostOk() (*float32, bool) {
	if o == nil || IsNil(o.Cost) {
		return nil, false
	}
	return o.Cost, true
...
func (o *PackageServiceUsage) HasCost() bool {
	if o != nil && !IsNil(o.Cost) {
		return true
	}
...
func (o *PackageServiceUsage) SetCost(v float32) {
	o.Cost = &v
}

func (o PackageServiceUsage) MarshalJSON() ([]byte, error) {
...
func (o PackageServiceUsage) ToMap() (map[string]interface{}, error) {
...
func (o *PackageServiceUsage) UnmarshalJSON(data []byte) (err error) {
	...
	varPackageServiceUsage := _PackageServiceUsage{}

	err = json.Unmarshal(data, &varPackageServiceUsage)

	if err != nil {
		return err
	}

	*o = PackageServiceUsage(varPackageServiceUsage)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "service_type")
		delete(additionalProperties, "usage_date")
...
type NullablePackageServiceUsage struct {
	value *PackageServiceUsage
	isSet bool
}

func (v NullablePackageServiceUsage) Get() *PackageServiceUsage {
	return v.value
}

func (v *NullablePackageServiceUsage) Set(val *PackageServiceUsage) {
	v.value = val
	v.isSet = true
}

func (v NullablePackageServiceUsage) IsSet() bool {
	return v.isSet
}

func (v *NullablePackageServiceUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePackageServiceUsage(val *PackageServiceUsage) *NullablePackageServiceUsage {
	return &NullablePackageServiceUsage{value: val, isSet: true}
}

func (v NullablePackageServiceUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePackageServiceUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
